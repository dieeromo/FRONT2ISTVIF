...
import {usePutTipoObrasMutation} from '../../services/bibliotecaApi'

const ModalTiposObras= ({ id, nombre_doc_default }) => {
    ...
    const [updTipoObra, { data, isSuccess }] = usePutTipoObrasMutation()

    const guardarCambios= (e) => {
        updTipoObra([user.access,id, documento])
        closeModal()
...
export default ModalTiposObras;
