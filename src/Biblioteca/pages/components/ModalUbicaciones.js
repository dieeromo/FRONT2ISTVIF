...
import {usePutUbicacionObrasMutation} from '../../services/bibliotecaApi'

const ModalUbicaciones = ({ id, nombre_doc_default }) => {
    ...
    const [updUbicacion, { data, isSuccess }] = usePutUbicacionObrasMutation()

    const guardarCambios= (e) => {
        updUbicacion([user.access,id, documento])
        closeModal()
