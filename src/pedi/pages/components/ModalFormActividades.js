...
import {useCreateActividades_metaMutation} from '../../services/pediApi'
import { AiFillTrophy } from "react-icons/ai";

export default function ModalFormActividades({ id_meta }) {
    ...
    const [createActividad, { data, isSuccess }] = useCreateActividades_metaMutation()
    ...
    const guardarCambios= (e) => {
        createActividad([user.access,actividad,id_meta,observacion, userDatos.id ])
                    ...
                    <div className="relative w-96 mx-auto my-6">
                        ...
                        <div className="bg-white rounded-lg shadow-lg outline-none focus:outline-none">
                            ...
                            <div className="relative p-6 flex-auto">
                                ...
                                <div className="mb-4">
                                    <label className="block text-xs font-bold mb-2">Actividad:</label>
                                    <textarea
                                        type="text"
                                        rows = {2}
                                        value={actividad}
