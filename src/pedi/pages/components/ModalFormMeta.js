...
import {useCreateMeta_ObjEspeMutation} from '../../services/pediApi'
import { AiFillTrophy } from "react-icons/ai";

export default function ModalFormMeta({ id_obj_especifico }) {
    ...
    const [createMeta, { data, isSuccess }] = useCreateMeta_ObjEspeMutation()
    ...
    const guardarCambios= (e) => {
        createMeta([user.access,meta,id_obj_especifico,observacion, userDatos.id ])
                    ...
                    <div className="relative w-96 mx-auto my-6">
                        ...
                        <div className="bg-white rounded-lg shadow-lg outline-none focus:outline-none">
                            ...
                            <div className="relative p-6 flex-auto">
                                ...
                                <div className="mb-4">
                                    <label className="block text-xs font-bold mb-2">Meta:</label>
                                    <textarea
                                        type="text"
                                        rows = {2}
                                        value={meta}
