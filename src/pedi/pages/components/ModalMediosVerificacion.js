...
import {useCreateMedioVerificacionMutation} from '../../services/pediApi'
import { AiFillTrophy } from "react-icons/ai";

export default function ModalMediosVerificacion({ id_actividad }) {
    ...
    const [createMedio, { data, isSuccess }] = useCreateMedioVerificacionMutation()
    ...
    const guardarCambios= (e) => {
        createMedio([user.access,medio,id_actividad,observacion, userDatos.id ])
                    ...
                    <div className="relative w-96 mx-auto my-6">
                        ...
                        <div className="bg-white rounded-lg shadow-lg outline-none focus:outline-none">
                            ...
                            <div className="flex items-center justify-between p-5 border-b border-gray-300 border-solid rounded-t">
                                <h3 className="text-lg font-semibold">Medio de verificacion</h3>
                                <button
                                    onClick={closeModal}
                            ...
                            <div className="relative p-6 flex-auto">
                                ...
                                <div className="mb-4">
                                    <label className="block text-xs font-bold mb-2">Medio de verificación:</label>
                                    <textarea
                                        type="text"
                                        rows = {2}
                                        value={medio}
