          ...
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:block">
              <ul className="flex space-x-4">
                <li><a href="/acreditacion/landing" className=" hover:text-gray-300">Acreditacion</a></li>
                <li><a href="#" className=" hover:text-gray-300">Gestión Biblioteca</a></li>
                <li><a href="#" className="hover:text-gray-300">Gestión Investario</a></li>
                ...
                :
                <li><a className=" text-white pl-2 pr-2 py-1 bg-gray-800 rounded hover:text-gray-300">Login </a></li>
